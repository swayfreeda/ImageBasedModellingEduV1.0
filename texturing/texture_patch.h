...
class TexturePatch {
    ...
    public:
        ...
        TexturePatch(int _label, std::vector<std::size_t> const & _faces,
            std::vector<math::Vec2f>  const & _texcoords, core::FloatImage::Ptr _image);
        ...
        static TexturePatch::Ptr create(int label, std::vector<std::size_t> const & faces,
            std::vector<math::Vec2f> const & texcoords, core::FloatImage::Ptr image);
        ...
        core::FloatImage::Ptr get_image(void);
