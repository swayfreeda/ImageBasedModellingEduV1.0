...
bool
edge_collapse (core::TriangleMesh::Ptr mesh, core::MeshInfo& mesh_info,
    ...
    float acos_threshold = 0.95f)
{
    ...
    core::MeshInfo::VertexInfo& vinfo1 = mesh_info[v1];
    ...
    core::MeshInfo::VertexInfo& vinfo2 = mesh_info[v2];
    ...
    core::MeshInfo::VertexInfo& vinfo3 = mesh_info[v3];
    vinfo3.remove_adjacent_face(afaces[0]);
    vinfo3.remove_adjacent_vertex(v2);
    core::MeshInfo::VertexInfo& vinfo4 = mesh_info[v4];
    ...
    vinfo2.faces.clear();
    vinfo2.verts.clear();
    vinfo2.vclass = core::MeshInfo::VERTEX_CLASS_UNREF;
...
clean_needles (core::TriangleMesh::Ptr mesh, float needle_ratio_thres)
{
    ...
    for (std::size_t i = 0; i < faces.size(); i += 3)
    {
        ...
        if (mesh_info[v1].vclass != core::MeshInfo::VERTEX_CLASS_SIMPLE
            || mesh_info[v2].vclass != core::MeshInfo::VERTEX_CLASS_SIMPLE)
            continue;
...
clean_caps (core::TriangleMesh::Ptr mesh)
{
    ...
    {
        core::MeshInfo::VertexInfo& vinfo = mesh_info[v1];
        if (vinfo.vclass != core::MeshInfo::VERTEX_CLASS_SIMPLE)
            continue;
